...
export class GameComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  private initLemonadeStand() {
    const lemonadeStandConfig = {
      imageUrl: assetUrl('assets/sprites/lemonade-stand.png'),
      frameWidth: 320,
      frameHeight: 320,
      totalFrames: 2,
      fps: 1,
  ...
  private shootLemonadeAt(zombie: ZombieState) {
    ...
    const lemonadeConfig = {
      imageUrl: assetUrl('assets/sprites/lemonade.png'),
      frameWidth: 128,
      frameHeight: 128,
      totalFrames: 1,
      currentFrame: 0,
  ...
  private createZombieSprite(zombie: ZombieState) {
    ...
    switch (zombie.type) {
      case 'king':
        spriteConfig = {
          imageUrl: assetUrl('assets/sprites/zombie-king.png'),
          frameWidth: 320,
          frameHeight: 320,
          totalFrames: 2,
          fps: 2,
      ...
      case 'fat':
        spriteConfig = {
          imageUrl: assetUrl('assets/sprites/fat-zombie.png'),
          frameWidth: 320,
          frameHeight: 320,
          totalFrames: 2,
          fps: 2,
      ...
      default:
        spriteConfig = {
          imageUrl: assetUrl('assets/sprites/zombie.png'),
          frameWidth: 320,
          frameHeight: 320,
          totalFrames: 2,
          fps: 2,
